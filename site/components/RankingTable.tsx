...
// meter with the fleet's median marked. The columns read in three blocks: where she is (place, to go, gap), how far and how fast she
// has been going (the miles first: 24-hour run, 7-day run; then the speeds: the latest 4-hour leg in knots, the 7 days drawn as bars,
// and her speed for the wind — the owner's order of 19 Sep, with the unit in the leg's title because a lone 7.1 among miles confused), against whom (the leader, the boats nearby, Van Den Heede). Until 19 Sep 2026 three links swapped ONE column between 4 hours, 24 hours and 7 days, and the
