...
function Spark({ series, width = 280, height = 78 }: { series: [number, number][]; width?: number; height?: number }) {
  ...
  return <svg width={width} height={height} viewBox={`0 0 ${width} ${height}`} style={{ display: "block" }} role="img" aria-label="The gap between the two boats at each report of the last three days">
