...
export function LineChart({ series, xs, ymin, ymax, yticks, xlab, ylab = signed, width = 560, height = 250 }: { series: { name: string; color: string; vals: number[] }[]; xs: number[]; ymin: number; ymax: number; yticks: number[]; xlab: (i: number) => string; ylab?: (v: number) => string; width?: number; height?: number }) {
