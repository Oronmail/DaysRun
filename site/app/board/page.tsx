...
export default async function Page() {
  ...
  return <div style={{ width: 1920, height: 1080, background: K.bg, color: K.text, display: "flex", flexDirection: "column", padding: "48px 72px 40px", boxSizing: "border-box", gap: 22, fontFamily: "var(--font-serif)" }}>
    ...
    <div style={{ display: "flex", justifyContent: "space-between", fontSize: 15, color: K.muted }}><span>Unofficial fleet statistics · {SITE_NAME} · not affiliated with the Golden Globe Race · nothing here may be relayed to a competitor (NOR F.8.2)</span><span>Positions: YB Tracking · Weather: Open-Meteo · PB = personal best · gold run = longest of the day</span></div>
  </div>;
}
