  ...
  return <Shell active="Method" dateline="HOW THE NUMBERS ARE MADE" title="METHOD" note="asked in the chat: what does each column mean?">
    <div className="stack" style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr) 380px", gap: 56 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}><div className="rule-title"><div className="label">Credits</div></div><div style={{ fontSize: 14, lineHeight: 1.55 }}>Built by fans. Inspired by Jonathan Endersby’s GGR Underground statistics for the 2022 race. Visits are counted anonymously, without cookies.</div></div>
