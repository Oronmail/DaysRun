...
export type Team = { id: number; name: string; first_name: string | null; country_code: string | null; colour: string | null; flag: string | null; model: string | null; yacht: string | null; design_class: string | null; sail: string | null; is_ghost: boolean; ghost_label: string | null; status: string | null };
export type BoatStat = { team_id: number; as_of: string; rank: number; rank_change: number | null; dtf_nm: number; gap_nm: number; interval_nm: number | null; last_fix_at: string; stale: boolean; lat: number; lon: number; position_text: string; spd4: number | null; vmg4: number | null; cmg4: number | null; spd24: number | null; vmg24: number | null; run24_nm: number | null; spd7: number | null; run7_nm: number | null; best4_kn: number; best4_at: string | null; best24_nm: number; best24_at: string | null; best7_nm: number | null; best7_at: string | null; sailed_nm: number; made_good_nm: number; vmg7_kn: number; pb24: boolean; fleet_best24: boolean; vs_vdh_nm: number | null; vs_vdh_days: number | null; vs_kirsten_nm: number | null; vs_kirsten_days: number | null; next_mark: string; next_mark_nm: number; next_mark_eta: string | null; restart_at: string | null; speed_log_json: (number | null)[]; team: Team ; gain24_nm: number | null; vs_near_nm: number | null; near_n: number | null; lever_nm: number | null; lever_dir: string | null };
