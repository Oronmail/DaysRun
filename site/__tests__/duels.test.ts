...
describe("duelStory", () => {
  it("tells a pass with how far back the new leader of the pair came from", () => {
    expect(duelStory(d({ gap_nm: 2, gap72_nm: -16, lead_changes: 1, passed_at: "2026-09-17T08:00:00+00:00" }), "Louis", "Guy")).toBe("Louis got ahead at 08:00 on 17 Sep, after trailing by 16 nm three days ago.");
    expect(duelStory(d({ gap_nm: 3, gap72_nm: -1, lead_changes: 3, passed_at: "2026-09-16T20:00:00+00:00" }), "Daniel", "Ertan")).toBe("Daniel got ahead at 20:00 on 16 Sep. The lead has changed hands 3 times in three days.");
  });
